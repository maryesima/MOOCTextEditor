...
public class EfficientDocument extends Document {
  ...
  /**
   * Passes through the text one time to count the number of words, syllables and sentences, and set
   * the member variables appropriately. Words, sentences and syllables are defined as described
   * below.
   */
