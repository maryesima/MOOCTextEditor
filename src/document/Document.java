...
public abstract class Document {
  ...
  /**
   * This is a helper function that returns the number of syllables in a word. You should write this
   * and use it in your BasicDocument class.
   *
   ...
   *     the end of a word is not considered a syllable unless the word has no other syllables. You
