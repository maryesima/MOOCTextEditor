    ...
    for (int numToCheck = start;
      ...
      // file to create both a BasicDocument and an EfficientDocument.
        ...
        for (int i = 0; i < trials; i++) {
          ...
          BasicDocument myDoc = new BasicDocument(text);
          myDoc.getFleschScore();
          long stopTimeBasic = System.nanoTime();
          long time1 = stopTimeBasic - startTimeBasic;
          long startTimeEfficient = System.nanoTime();
          EfficientDocument myEfficientDoc = new EfficientDocument(text);
          myEfficientDoc.getFleschScore();
          long stopTimeEfficient = System.nanoTime();
          long time2 = stopTimeEfficient - startTimeEfficient;
          System.out.println(numToCheck + "\t" + time1 + "\t" + time2 + "\n");
        }
